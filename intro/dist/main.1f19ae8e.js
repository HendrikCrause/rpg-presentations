...
exports.default = _default;
  ...
  return _c("div", [
    ...
    _c("h4", { staticClass: "subtitle" }, [_vm._v(_vm._s(_vm.subtitle))]),
...
var _default = {
  slideDefinitions: [{
    ...
    subtitle: '',
    points: ['Most common reason for playing', 'Meet new people', 'Become part of a growing and passionate community'],
    enterNext: 'slideInUp',
    ...
    subtitle: '',
    points: ['Exploring old Dungeons', 'Fighting armies of monsters', 'Saving those in need', 'Exploring a fantasy world']
  }, {
    type: 'Bullets',
